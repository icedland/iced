 ...
 */
public final class AsmRegister8 {
	/**
	 * Creates a new instance.
	 *
	 * @param register Register
	 */
	public AsmRegister8(ICRegister register) {
		if (!Register.isGPR8(register.get()))
			throw new IllegalArgumentException("Invalid register value. Must be a GPR8 register");
	...
	public boolean equals(Object obj) {
		if (obj == null || getClass() != obj.getClass())
			return false;
		AsmRegister8 other = (AsmRegister8)obj;
