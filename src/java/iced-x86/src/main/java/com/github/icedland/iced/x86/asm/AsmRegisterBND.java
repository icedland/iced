 ...
 */
public final class AsmRegisterBND {
	/**
	 * Creates a new instance.
	 *
	 * @param register Register
	 */
	public AsmRegisterBND(ICRegister register) {
		if (!Register.isBND(register.get()))
			throw new IllegalArgumentException("Invalid register value. Must be a BND register");
	...
	public boolean equals(Object obj) {
		if (obj == null || getClass() != obj.getClass())
			return false;
		AsmRegisterBND other = (AsmRegisterBND)obj;
