 ...
 */
public final class AsmRegisterTMM {
	/**
	 * Creates a new instance.
	 *
	 * @param register Register
	 */
	public AsmRegisterTMM(ICRegister register) {
		if (!Register.isTMM(register.get()))
			throw new IllegalArgumentException("Invalid register value. Must be a TMM register");
	...
	public boolean equals(Object obj) {
		if (obj == null || getClass() != obj.getClass())
			return false;
		AsmRegisterTMM other = (AsmRegisterTMM)obj;
