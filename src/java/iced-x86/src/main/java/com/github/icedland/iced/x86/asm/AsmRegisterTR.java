 ...
 */
public final class AsmRegisterTR {
	/**
	 * Creates a new instance.
	 *
	 * @param register Register
	 */
	public AsmRegisterTR(ICRegister register) {
		if (!Register.isTR(register.get()))
			throw new IllegalArgumentException("Invalid register value. Must be a TR register");
	...
	public boolean equals(Object obj) {
		if (obj == null || getClass() != obj.getClass())
			return false;
		AsmRegisterTR other = (AsmRegisterTR)obj;
