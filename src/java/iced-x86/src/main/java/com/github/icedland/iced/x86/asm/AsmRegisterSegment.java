 ...
 */
public final class AsmRegisterSegment {
	/**
	 * Creates a new instance.
	 *
	 * @param register Register
	 */
	public AsmRegisterSegment(ICRegister register) {
		if (!Register.isSegmentRegister(register.get()))
			throw new IllegalArgumentException("Invalid register value. Must be a SegmentRegister register");
	...
	public boolean equals(Object obj) {
		if (obj == null || getClass() != obj.getClass())
			return false;
		AsmRegisterSegment other = (AsmRegisterSegment)obj;
