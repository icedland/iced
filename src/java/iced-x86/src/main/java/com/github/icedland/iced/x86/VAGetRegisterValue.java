...
public interface VAGetRegisterValue {
	 ...
	 * register value. If it's not possible to read the register value, this method should return <code>null</code>
	 *
	 ...
	 * @return <code>null</code> if it failed to read the register, else the value of the register
	 */
