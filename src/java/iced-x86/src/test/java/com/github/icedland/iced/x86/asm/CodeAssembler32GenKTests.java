...
final class CodeAssembler32GenKTests extends CodeAssemblerTestsBase {
	CodeAssembler32GenKTests() {
		super(32);
	}
	...
	@Test
	void kmovb_m_kr() {
		testAssembler(c -> c.kmovb(mem_ptr(0x0L).base(ecx), k3), Instruction.create(Code.VEX_KMOVB_M8_KR, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE), ICRegisters.k3));
	}

	@Test
	void kmovb_kr_m() {
		testAssembler(c -> c.kmovb(k2, mem_ptr(0x0L).base(ecx)), Instruction.create(Code.VEX_KMOVB_KR_KM8, ICRegisters.k2, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE)));
	}
	...
	@Test
	void kmovd_m_kr() {
		testAssembler(c -> c.kmovd(mem_ptr(0x0L).base(ecx), k3), Instruction.create(Code.VEX_KMOVD_M32_KR, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE), ICRegisters.k3));
	}

	@Test
	void kmovd_kr_m() {
		testAssembler(c -> c.kmovd(k2, mem_ptr(0x0L).base(ecx)), Instruction.create(Code.VEX_KMOVD_KR_KM32, ICRegisters.k2, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE)));
	}
	...
	@Test
	void kmovq_m_kr() {
		testAssembler(c -> c.kmovq(mem_ptr(0x0L).base(ecx), k3), Instruction.create(Code.VEX_KMOVQ_M64_KR, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE), ICRegisters.k3));
	}

	@Test
	void kmovq_kr_m() {
		testAssembler(c -> c.kmovq(k2, mem_ptr(0x0L).base(ecx)), Instruction.create(Code.VEX_KMOVQ_KR_KM64, ICRegisters.k2, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE)));
	}
	...
	@Test
	void kmovw_m_kr() {
		testAssembler(c -> c.kmovw(mem_ptr(0x0L).base(ecx), k3), Instruction.create(Code.VEX_KMOVW_M16_KR, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE), ICRegisters.k3));
	}

	@Test
	void kmovw_kr_m() {
		testAssembler(c -> c.kmovw(k2, mem_ptr(0x0L).base(ecx)), Instruction.create(Code.VEX_KMOVW_KR_KM16, ICRegisters.k2, new MemoryOperand(ICRegisters.ecx, ICRegister.NONE, 1, 0x0L, 0, false, ICRegister.NONE)));
	}
