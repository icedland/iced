...
FORMATTER_SYNTAX = FormatterSyntax.MASM
...
def test_format():
	...
	assert formatter.format(instr) == "vcvtne2ps2bf16 zmm2{k5}{z},zmm6,dword bcst [rax+4]"
	...
	assert formatter.format_operand(instr, 2) == "dword bcst [rax+4]"
	assert formatter.format_operand_separator(instr) == ","
	assert formatter.format_all_operands(instr) == "zmm2{k5}{z},zmm6,dword bcst [rax+4]"
