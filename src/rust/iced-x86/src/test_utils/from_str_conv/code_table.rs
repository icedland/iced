...
lazy_static! {
	pub(super) static ref TO_CODE_HASH: HashMap<&'static str, Code> = {
		...
		let mut h = HashMap::with_capacity(4818);
		...
		let _ = h.insert("MVEX_Vprefetchnta_mt", Code::MVEX_Vprefetchnta_mt);
		let _ = h.insert("MVEX_Vprefetch0_mt", Code::MVEX_Vprefetch0_mt);
		let _ = h.insert("MVEX_Vprefetch1_mt", Code::MVEX_Vprefetch1_mt);
		let _ = h.insert("MVEX_Vprefetch2_mt", Code::MVEX_Vprefetch2_mt);
		let _ = h.insert("MVEX_Vprefetchenta_mt", Code::MVEX_Vprefetchenta_mt);
		let _ = h.insert("MVEX_Vprefetche0_mt", Code::MVEX_Vprefetche0_mt);
		let _ = h.insert("MVEX_Vprefetche1_mt", Code::MVEX_Vprefetche1_mt);
		let _ = h.insert("MVEX_Vprefetche2_mt", Code::MVEX_Vprefetche2_mt);
		...
		let _ = h.insert("MVEX_Clevict1_mt", Code::MVEX_Clevict1_mt);
		let _ = h.insert("MVEX_Clevict0_mt", Code::MVEX_Clevict0_mt);
