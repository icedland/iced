...
lazy_static! {
	pub(super) static ref TO_CODE_HASH: HashMap<&'static str, Code> = {
		...
		let mut h = HashMap::with_capacity(4830);
		...
		let _ = h.insert("Xstore2_16", Code::Xstore2_16);
		let _ = h.insert("Xstore2_32", Code::Xstore2_32);
		let _ = h.insert("Xstore2_64", Code::Xstore2_64);
