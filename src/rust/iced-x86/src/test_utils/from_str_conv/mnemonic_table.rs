...
lazy_static! {
	pub(super) static ref TO_MNEMONIC_HASH: HashMap<&'static str, Mnemonic> = {
		...
		let mut h = HashMap::with_capacity(1629);
		...
		h.insert("Rdshr", Mnemonic::Rdshr);
		h.insert("Wrshr", Mnemonic::Wrshr);
		h.insert("Smint", Mnemonic::Smint);
		h.insert("Dmint", Mnemonic::Dmint);
		h.insert("Rdm", Mnemonic::Rdm);
		h.insert("Svdc", Mnemonic::Svdc);
		h.insert("Rsdc", Mnemonic::Rsdc);
		h.insert("Svldt", Mnemonic::Svldt);
		h.insert("Rsldt", Mnemonic::Rsldt);
		h.insert("Svts", Mnemonic::Svts);
		h.insert("Rsts", Mnemonic::Rsts);
		h.insert("Bb0_reset", Mnemonic::Bb0_reset);
		h.insert("Bb1_reset", Mnemonic::Bb1_reset);
		h.insert("Cpu_write", Mnemonic::Cpu_write);
		h.insert("Cpu_read", Mnemonic::Cpu_read);
		h.insert("Altinst", Mnemonic::Altinst);
		h.insert("Paveb", Mnemonic::Paveb);
		h.insert("Paddsiw", Mnemonic::Paddsiw);
		h.insert("Pmagw", Mnemonic::Pmagw);
		h.insert("Pdistib", Mnemonic::Pdistib);
		h.insert("Psubsiw", Mnemonic::Psubsiw);
		h.insert("Pmvzb", Mnemonic::Pmvzb);
		h.insert("Pmvnzb", Mnemonic::Pmvnzb);
		h.insert("Pmvlzb", Mnemonic::Pmvlzb);
		h.insert("Pmvgezb", Mnemonic::Pmvgezb);
		h.insert("Pmulhriw", Mnemonic::Pmulhriw);
		h.insert("Pmachriw", Mnemonic::Pmachriw);
		h.insert("Ftstp", Mnemonic::Ftstp);
		h.insert("Frint2", Mnemonic::Frint2);
		h.insert("Frichop", Mnemonic::Frichop);
		h.insert("Frinear", Mnemonic::Frinear);
		h.insert("Undoc", Mnemonic::Undoc);
		h.insert("Tdcall", Mnemonic::Tdcall);
		h.insert("Seamret", Mnemonic::Seamret);
		h.insert("Seamops", Mnemonic::Seamops);
		h.insert("Seamcall", Mnemonic::Seamcall);
		h.insert("Aesencwide128kl", Mnemonic::Aesencwide128kl);
		h.insert("Aesdecwide128kl", Mnemonic::Aesdecwide128kl);
		h.insert("Aesencwide256kl", Mnemonic::Aesencwide256kl);
		h.insert("Aesdecwide256kl", Mnemonic::Aesdecwide256kl);
		h.insert("Loadiwkey", Mnemonic::Loadiwkey);
		h.insert("Aesenc128kl", Mnemonic::Aesenc128kl);
		h.insert("Aesdec128kl", Mnemonic::Aesdec128kl);
		h.insert("Aesenc256kl", Mnemonic::Aesenc256kl);
		h.insert("Aesdec256kl", Mnemonic::Aesdec256kl);
		h.insert("Encodekey128", Mnemonic::Encodekey128);
		h.insert("Encodekey256", Mnemonic::Encodekey256);
		h.insert("Pushad", Mnemonic::Pushad);
		h.insert("Popad", Mnemonic::Popad);
		h.insert("Pushfd", Mnemonic::Pushfd);
		h.insert("Pushfq", Mnemonic::Pushfq);
		h.insert("Popfd", Mnemonic::Popfd);
		h.insert("Popfq", Mnemonic::Popfq);
		h.insert("Iretd", Mnemonic::Iretd);
		h.insert("Iretq", Mnemonic::Iretq);
		h.insert("Int3", Mnemonic::Int3);
		h.insert("Uiret", Mnemonic::Uiret);
		h.insert("Testui", Mnemonic::Testui);
		h.insert("Clui", Mnemonic::Clui);
		h.insert("Stui", Mnemonic::Stui);
		h.insert("Senduipi", Mnemonic::Senduipi);
		h.insert("Hreset", Mnemonic::Hreset);
		h.insert("Ccs_hash", Mnemonic::Ccs_hash);
		h.insert("Ccs_encrypt", Mnemonic::Ccs_encrypt);
