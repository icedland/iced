...
lazy_static! {
	pub(super) static ref TO_MEMORY_SIZE_HASH: HashMap<&'static str, MemorySize> = {
		...
		h.insert("SegmentDescSelector", MemorySize::SegmentDescSelector);
		h.insert("KLHandleAes128", MemorySize::KLHandleAes128);
		h.insert("KLHandleAes256", MemorySize::KLHandleAes256);
