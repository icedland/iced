...
use crate::code_asm::{__AsmRegister16, __AsmRegister32, __AsmRegister64, __AsmRegisterXmm, __AsmRegisterYmm, __AsmRegisterZmm};
...
impl crate::code_asm::private::Sealed for __AsmMemoryOperand {}

impl __AsmMemoryOperand {
...
impl<R: Into<Register>> From<R> for __AsmMemoryOperand {
	#[inline]
	fn from(other: R) -> Self {
		__AsmMemoryOperand { base: other.into(), index: Register::None, scale: 1, displ: 0, state: CodeAsmOpState::new() }
	}
}
...
macro_rules! displ_to_mem_op {
	($($displ_ty:ty)+) => {
		$(
			impl crate::code_asm::private::Sealed for $displ_ty {}
			impl From<$displ_ty> for __AsmMemoryOperand {
				#[inline]
	...
	($reg_ty:ty, $($displ_ty:ty)+) => {
		$(
			impl Add<$displ_ty> for $reg_ty {
				type Output = __AsmMemoryOperand;
				#[inline]
				#[allow(trivial_numeric_casts)]
...
reg_plus_displ!(__AsmRegister16, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_plus_displ!(__AsmRegister32, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_plus_displ!(__AsmRegister64, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
...
reg_mul_scale!(__AsmRegister32, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_mul_scale!(__AsmRegister64, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_mul_scale!(__AsmRegisterXmm, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_mul_scale!(__AsmRegisterYmm, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
reg_mul_scale!(__AsmRegisterZmm, i8 i16 i32 i64 isize u8 u16 u32 u64 usize);
		...
		$(
			impl Add<$right_ty> for $left_ty {
				...
				fn add(self, rhs: $right_ty) -> Self::Output {
					__AsmMemoryOperand { base: self.into(), index: rhs.into(), scale: 1, displ: 0, state: CodeAsmOpState::new() }
				}
			}
		)+
	};
}
reg_plus_reg!(__AsmRegister16, __AsmRegister16);
reg_plus_reg!(__AsmRegister32, __AsmRegister32 __AsmRegisterXmm __AsmRegisterYmm __AsmRegisterZmm);
reg_plus_reg!(__AsmRegister64, __AsmRegister64 __AsmRegisterXmm __AsmRegisterYmm __AsmRegisterZmm);
	...
	($($left_ty:ty)+, $right_ty:ty) => {
		$(
			impl Add<$right_ty> for $left_ty {
				...
				#[inline]
				fn add(self, rhs: $right_ty) -> Self::Output {
					__AsmMemoryOperand { base: rhs.into(), index: self.into(), scale: 1, displ: 0, state: CodeAsmOpState::new() }
				}
			}
		)+
	};
}
indexreg_plus_reg!(__AsmRegisterXmm __AsmRegisterYmm __AsmRegisterZmm, __AsmRegister32);
indexreg_plus_reg!(__AsmRegisterXmm __AsmRegisterYmm __AsmRegisterZmm, __AsmRegister64);

macro_rules! reg_plus_mem {
	($($reg_ty:ty)+) => {
		$(
			impl Add<__AsmMemoryOperand> for $reg_ty {
				type Output = __AsmMemoryOperand;
				#[inline]
				fn add(self, mut rhs: __AsmMemoryOperand) -> Self::Output {
					rhs.base = self.into();
					rhs
				}
			}

			impl Add<$reg_ty> for __AsmMemoryOperand {
				type Output = __AsmMemoryOperand;
				#[inline]
...
reg_plus_mem!(__AsmRegister16 __AsmRegister32 __AsmRegister64);

macro_rules! mem_plus_displ {
	($($displ_ty:ty)+) => {
		$(
			impl Add<$displ_ty> for __AsmMemoryOperand {
				type Output = __AsmMemoryOperand;
				#[inline]
				#[allow(trivial_numeric_casts)]
			...
			impl Add<__AsmMemoryOperand> for $displ_ty {
				type Output = __AsmMemoryOperand;
				#[inline]
				#[allow(trivial_numeric_casts)]
				fn add(self, mut rhs: __AsmMemoryOperand) -> Self::Output {
			...
			impl Sub<$displ_ty> for __AsmMemoryOperand {
				type Output = __AsmMemoryOperand;
				#[inline]
				#[allow(trivial_numeric_casts)]
...
impl Add<__AsmMemoryOperand> for __AsmMemoryOperand {
	type Output = __AsmMemoryOperand;
	#[inline]
	fn add(mut self, rhs: __AsmMemoryOperand) -> Self::Output {
...
#[inline]
#[rustfmt::skip]
pub fn ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn byte_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().byte_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn word_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().word_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn dword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().dword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn qword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().qword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn mmword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().mmword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn tbyte_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().tbyte_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn tword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().tword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn fword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().fword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn oword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().oword_ptr()
}
...
#[inline]
#[rustfmt::skip]
pub fn xmmword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
...
#[inline]
#[rustfmt::skip]
pub fn ymmword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
...
#[inline]
#[rustfmt::skip]
pub fn zmmword_ptr<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
...
#[inline]
#[rustfmt::skip]
pub fn bcst<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().bcst()
}
...
#[inline]
#[rustfmt::skip]
pub fn word_bcst<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().word_bcst()
}
...
#[inline]
#[rustfmt::skip]
pub fn dword_bcst<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().dword_bcst()
}
...
#[inline]
#[rustfmt::skip]
pub fn qword_bcst<M: Into<__AsmMemoryOperand>>(mem: M) -> __AsmMemoryOperand {
	mem.into().qword_bcst()
}
