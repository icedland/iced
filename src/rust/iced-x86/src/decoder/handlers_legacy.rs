...
impl OpCodeHandler_VEX2 {
	pub(super) fn new(handler_mem: (*const OpCodeHandler, OpCodeHandlerDecodeFn)) -> Self {
		...
		Self { has_modrm: true, decode: OpCodeHandler_VEX2::decode, handler_mem: (unsafe { &*handler_mem.0 }, handler_mem.1) }
	}
...
impl OpCodeHandler_VEX3 {
	pub(super) fn new(handler_mem: (*const OpCodeHandler, OpCodeHandlerDecodeFn)) -> Self {
		debug_assert!(!is_null_instance_handler(handler_mem.0));
		Self { has_modrm: true, decode: OpCodeHandler_VEX3::decode, handler_mem: (unsafe { &*handler_mem.0 }, handler_mem.1) }
	}
...
impl OpCodeHandler_XOP {
	pub(super) fn new(handler_reg0: (*const OpCodeHandler, OpCodeHandlerDecodeFn)) -> Self {
		...
		Self { has_modrm: true, decode: OpCodeHandler_XOP::decode, handler_reg0: (unsafe { &*handler_reg0.0 }, handler_reg0.1) }
	}
...
impl OpCodeHandler_EVEX {
	pub(super) fn new(handler_mem: (*const OpCodeHandler, OpCodeHandlerDecodeFn)) -> Self {
		debug_assert!(!is_null_instance_handler(handler_mem.0));
		Self { has_modrm: true, decode: OpCodeHandler_EVEX::decode, handler_mem: (unsafe { &*handler_mem.0 }, handler_mem.1) }
	}
