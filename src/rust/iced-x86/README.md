...
[![Minimum rustc version](https://img.shields.io/badge/rustc-1.64.0+-blue.svg)](#minimum-supported-rustc-version)
...
- 👍 Supports `rustc` `1.64.0` or later
...
iced-x86 supports `rustc` `1.64.0` or later.
