...
describe("Instruction", function()
	...
	it("immediate", function()
		...
		assert.equals(0x80, instr:immediate8(0))
		instr:set_immediate8(0xFF)
		assert.equals(0xFF, instr:immediate(0))
		assert.equals(0xFF, instr:immediate8(0))
		assert.has_error(function()
		...
		assert.equals(-0x80, instr:immediate8to16(1))
		instr:set_immediate8to16(0x7F)
		assert.equals(0x7F, instr:immediate(1))
		assert.equals(0x7F, instr:immediate8to16(1))
		assert.has_error(function()
		...
		assert.equals(-0x80, instr:immediate(1))
		assert.equals(-0x80, instr:immediate8to32(1))
		instr:set_immediate8to32(0x7F)
		assert.equals(0x7F, instr:immediate(1))
		assert.equals(0x7F, instr:immediate8to32(1))
		assert.has_error(function()
		...
		assert.equals(0x8000, instr:immediate16(1))
		instr:set_immediate16(0xFFFF)
		assert.equals(0xFFFF, instr:immediate(1))
		assert.equals(0xFFFF, instr:immediate16(1))
		assert.has_error(function()
		...
		assert.equals(0xFFFFFFFF, instr:immediate(0))
		assert.has_error(function()
			instr:set_immediate_i32(-0x80000001)
		end)
		assert.has_error(function()
			instr:set_immediate_i32(0x100000000)
		end)
		...
		assert.equals(0xFFFFFFFF, instr:immediate(0))
		assert.has_error(function()
			instr:set_immediate_u32(-0x80000001)
		end)
		assert.has_error(function()
			instr:set_immediate_u32(0x100000000)
		end)
