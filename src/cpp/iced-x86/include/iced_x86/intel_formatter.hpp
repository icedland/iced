...
inline std::string_view IntelFormatter::format_register( Register reg ) const noexcept {
...
inline std::string IntelFormatter::format_to_string( const Instruction& instruction ) {
  std::string result;
...
inline void IntelFormatter::format( const Instruction& instruction, FormatterOutput& output ) {
  // Format prefixes
...
inline void IntelFormatter::format_mnemonic( const Instruction& instruction, FormatterOutput& output ) {
  std::string_view mnemonic = get_mnemonic( instruction.mnemonic() );
  output.write_mnemonic( instruction, mnemonic );
}

inline void IntelFormatter::format_operands( const Instruction& instruction, FormatterOutput& output ) {
  uint32_t op_count = instruction.op_count();
...
inline void IntelFormatter::format_operand( const Instruction& instruction, uint32_t operand,
                                            FormatterOutput& output ) {
...
inline void IntelFormatter::format_register_operand( const Instruction& instruction, uint32_t operand,
...
inline void IntelFormatter::format_immediate( const Instruction& instruction, uint32_t operand,
                                              FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
  uint64_t value = 0;
...
inline void IntelFormatter::format_near_branch( const Instruction& instruction, uint32_t operand,
                                                FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
  uint64_t target = 0;
  int addr_size = 4;
...
inline void IntelFormatter::format_far_branch( const Instruction& instruction, uint32_t operand,
                                               FormatterOutput& output ) {
  (void)operand;
...
inline void IntelFormatter::format_memory( const Instruction& instruction, uint32_t operand,
                                           FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
...
inline void IntelFormatter::format_number( uint64_t value, FormatterOutput& output ) {
...
inline void IntelFormatter::format_signed_number( int64_t value, FormatterOutput& output ) {
  if ( value < 0 ) {
    output.write( "-", FormatterTextKind::OPERATOR );
...
inline void IntelFormatter::write_symbol( const Instruction& instruction, FormatterOutput& output,
...
inline void IntelFormatter::format_evex_decorators( const Instruction& instruction, uint32_t operand,
                                                     FormatterOutput& output ) {
  (void)operand;
...
inline std::string_view IntelFormatter::get_mnemonic( Mnemonic mnemonic ) const {
  bool uppercase = options_.uppercase_mnemonics() || options_.uppercase_all();
  return internal::get_mnemonic_string( mnemonic, uppercase );
}

inline std::string_view IntelFormatter::get_memory_size_string( const Instruction& instruction ) const {
