...
namespace Generator.Enums.Java {
	...
	sealed class JavaEnumsGenerator : EnumsGenerator {
		...
		public JavaEnumsGenerator(GeneratorContext generatorContext)
			...
			toFullFileInfo.Add(TypeIds.GasCtorKind, FullEnumFileInfo.Create(genTypes, JavaConstants.GasFormatterInternalPackage, "CtorKind.java"));
			toFullFileInfo.Add(TypeIds.IntelCtorKind, FullEnumFileInfo.Create(genTypes, JavaConstants.IntelFormatterInternalPackage, "CtorKind.java"));
			toFullFileInfo.Add(TypeIds.MasmCtorKind, FullEnumFileInfo.Create(genTypes, JavaConstants.MasmFormatterInternalPackage, "CtorKind.java"));
			toFullFileInfo.Add(TypeIds.NasmCtorKind, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "CtorKind.java"));
			toFullFileInfo.Add(TypeIds.GasSizeOverride, FullEnumFileInfo.Create(genTypes, JavaConstants.GasFormatterInternalPackage, "SizeOverride.java"));
			toFullFileInfo.Add(TypeIds.GasInstrOpInfoFlags, FullEnumFileInfo.Create(genTypes, JavaConstants.GasFormatterInternalPackage, "InstrOpInfoFlags.java"));
			toFullFileInfo.Add(TypeIds.IntelSizeOverride, FullEnumFileInfo.Create(genTypes, JavaConstants.IntelFormatterInternalPackage, "SizeOverride.java"));
			toFullFileInfo.Add(TypeIds.IntelBranchSizeInfo, FullEnumFileInfo.Create(genTypes, JavaConstants.IntelFormatterInternalPackage, "BranchSizeInfo.java"));
			toFullFileInfo.Add(TypeIds.IntelInstrOpInfoFlags, FullEnumFileInfo.Create(genTypes, JavaConstants.IntelFormatterInternalPackage, "InstrOpInfoFlags.java"));
			toFullFileInfo.Add(TypeIds.MasmInstrOpInfoFlags, FullEnumFileInfo.Create(genTypes, JavaConstants.MasmFormatterInternalPackage, "InstrOpInfoFlags.java"));
			toFullFileInfo.Add(TypeIds.NasmSignExtendInfo, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "SignExtendInfo.java"));
			toFullFileInfo.Add(TypeIds.NasmSizeOverride, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "SizeOverride.java"));
			toFullFileInfo.Add(TypeIds.NasmBranchSizeInfo, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "BranchSizeInfo.java"));
			toFullFileInfo.Add(TypeIds.NasmInstrOpInfoFlags, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "InstrOpInfoFlags.java"));
			toFullFileInfo.Add(TypeIds.FastFmtFlags, FullEnumFileInfo.Create(genTypes, JavaConstants.FastFormatterInternalPackage, "FastFmtFlags.java"));
			...
			toFullFileInfo.Add(TypeIds.GasInstrOpKind, FullEnumFileInfo.Create(genTypes, JavaConstants.GasFormatterInternalPackage, "InstrOpKind.java"));
			toFullFileInfo.Add(TypeIds.IntelInstrOpKind, FullEnumFileInfo.Create(genTypes, JavaConstants.IntelFormatterInternalPackage, "InstrOpKind.java"));
			toFullFileInfo.Add(TypeIds.MasmInstrOpKind, FullEnumFileInfo.Create(genTypes, JavaConstants.MasmFormatterInternalPackage, "InstrOpKind.java"));
			...
			toFullFileInfo.Add(TypeIds.NasmInstrOpKind, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "InstrOpKind.java"));
			toFullFileInfo.Add(TypeIds.NasmMemorySizeInfo, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "MemorySizeInfo.java"));
			toFullFileInfo.Add(TypeIds.NasmFarMemorySizeInfo, FullEnumFileInfo.Create(genTypes, JavaConstants.NasmFormatterInternalPackage, "FarMemorySizeInfo.java"));
