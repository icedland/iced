...
namespace Generator.Enums.CSharp {
	...
	sealed class CSharpEnumsGenerator : EnumsGenerator {
		...
		public CSharpEnumsGenerator(GeneratorContext generatorContext)
			...
			toFullFileInfo.Add(TypeIds.OpCodeHandlerKind, new FullEnumFileInfo(CSharpConstants.GetFilename(genTypes, CSharpConstants.DecoderNamespace, nameof(TypeIds.OpCodeHandlerKind) + ".g.cs"), CSharpConstants.DecoderNamespace, CSharpConstants.DecoderDefine, baseType: "byte"));
			...
			toFullFileInfo.Add(TypeIds.MvexInfoFlags, new FullEnumFileInfo(CSharpConstants.GetFilename(genTypes, CSharpConstants.IcedNamespace, nameof(TypeIds.MvexInfoFlags) + ".g.cs"), CSharpConstants.IcedNamespace, CSharpConstants.MvexDefine));
