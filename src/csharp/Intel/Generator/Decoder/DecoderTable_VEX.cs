		...
		public static (string name, object?[] handlers)[] CreateHandlers(GenTypes genTypes) {
			...
			var handlers = new (string name, object?[] handlers)[] {
				...
				new object[0x100] {
					...
					// 48
					invalid,
					new object[] { kind[nameof(OpCodeHandlerKind.Bitness)],
						invalid,
						new object[] { MandatoryPrefix2_4,
							new object[] { W,
								new object[] { VectorLength,
									new object[] { kind[nameof(OpCodeHandlerKind.Group8x64)], "handlers_Grp_128_NP_0F38_W0_49_lo", "handlers_Grp_128_NP_0F38_W0_49_hi" },
									invalid,
								},
								invalid,
							},
							new object[] { W,
								new object[] { VectorLength,
									new object[] { kind[nameof(OpCodeHandlerKind.Group8x64)], "handlers_Grp_128_66_0F38_W0_49_lo", "handlers_Grp_128_66_0F38_W0_49_hi" },
									invalid,
								},
								invalid,
							},
							...
							new object[] { W,
								new object[] { VectorLength,
									new object[] { kind[nameof(OpCodeHandlerKind.Group8x64)], "handlers_Grp_128_F2_0F38_W0_49_lo", "handlers_Grp_128_F2_0F38_W0_49_hi" },
									invalid,
								},
								invalid,
							},
						...
						new object[] { VectorLength,
							new object[] { W,
								new object[] { Options_DontReadModRM,
									...
									new object[] { Bitness_DontReadModRM,
										invalid,
										new object[] { VK_R_Ib, code[nameof(Code.VEX_KNC_Kextract_kr_r64_imm8)] },
									}, options[nameof(DecoderOptions.KNC)]
								},
								invalid,
							},
