			...
			var handlers = new (string name, object?[] handlers)[] {
				...
				new object[8] {
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetchnta_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetch0_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetch1_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetch2_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetchenta_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetche0_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetche1_mt)] },
						invalid,
						invalid,
						invalid,
					},
					new object[] { MandatoryPrefix2,
						new object[] { M, code[nameof(Code.MVEX_Vprefetche2_mt)] },
						invalid,
						invalid,
						invalid,
					},
				...
				new object[8] {
					...
					new object[] { MandatoryPrefix2,
						invalid,
						invalid,
						new object[] { M, code[nameof(Code.MVEX_Clevict1_mt)] },
						new object[] { M, code[nameof(Code.MVEX_Clevict0_mt)] },
					},
				}),
