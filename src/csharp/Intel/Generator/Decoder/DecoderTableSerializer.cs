	...
	abstract class DecoderTableSerializer {
		...
		static Dictionary<IEnumValue, (int codeIndex, int codeLen)> CreateEnumValueInfo(GenTypes genTypes) {
			...
			return new Dictionary<IEnumValue, (int codeIndex, int codeLen)> {
				...
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.Ed_V_Ib)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.Gv_Ev_Ib_REX)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.Gv_RX)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.Gv_W)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.GvM_VX_Ib)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.V_Ev)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.VWIb_3)], (2, 2) },
				{ opCodeHandlerKind[nameof(LegacyOpCodeHandlerKind.VX_E_Ib)], (2, 2) },
