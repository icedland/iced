...
namespace Iced.Intel {
	static partial class IcedConstants {
		...
		internal const int MaxCpuidFeatureInternalValues = 194;
		...
		internal const int MnemonicEnumCount = 1879;
