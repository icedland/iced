...
namespace Iced.Intel {
	static partial class IcedConstants {
		...
		internal const int MaxCpuidFeatureInternalValues = 193;
		...
		internal const int MnemonicEnumCount = 1877;
