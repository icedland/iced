	...
	static class OpCodeHandlers32Tables {
		...
		static OpCodeHandlers32Tables() {
			...
			OneByteHandlers = new OpCodeHandler[0x100] {
				...
				new OpCodeHandler_EVEX(new OpCodeHandler_Gv_Ma(Code.Bound_r16_m1616, Code.Bound_r32_m3232, MemorySize.Bound16_WordWord, MemorySize.Bound32_DwordDword)),
				...
				// B0
				new OpCodeHandler_RegIb(Code.Mov_AL_imm8, Register.AL),
				new OpCodeHandler_RegIb(Code.Mov_CL_imm8, Register.CL),
				new OpCodeHandler_RegIb(Code.Mov_DL_imm8, Register.DL),
				new OpCodeHandler_RegIb(Code.Mov_BL_imm8, Register.BL),
				new OpCodeHandler_RegIb(Code.Mov_AH_imm8, Register.AH),
				new OpCodeHandler_RegIb(Code.Mov_CH_imm8, Register.CH),
				new OpCodeHandler_RegIb(Code.Mov_DH_imm8, Register.DH),
				new OpCodeHandler_RegIb(Code.Mov_BH_imm8, Register.BH),

				// B8
				new OpCodeHandler_Reg_Iz(Code.Mov_AX_imm16, Code.Mov_EAX_imm32, Register.AX, Register.EAX),
				new OpCodeHandler_Reg_Iz(Code.Mov_CX_imm16, Code.Mov_ECX_imm32, Register.CX, Register.ECX),
				new OpCodeHandler_Reg_Iz(Code.Mov_DX_imm16, Code.Mov_EDX_imm32, Register.DX, Register.EDX),
				new OpCodeHandler_Reg_Iz(Code.Mov_BX_imm16, Code.Mov_EBX_imm32, Register.BX, Register.EBX),
				new OpCodeHandler_Reg_Iz(Code.Mov_SP_imm16, Code.Mov_ESP_imm32, Register.SP, Register.ESP),
				new OpCodeHandler_Reg_Iz(Code.Mov_BP_imm16, Code.Mov_EBP_imm32, Register.BP, Register.EBP),
				new OpCodeHandler_Reg_Iz(Code.Mov_SI_imm16, Code.Mov_ESI_imm32, Register.SI, Register.ESI),
				new OpCodeHandler_Reg_Iz(Code.Mov_DI_imm16, Code.Mov_EDI_imm32, Register.DI, Register.EDI),
