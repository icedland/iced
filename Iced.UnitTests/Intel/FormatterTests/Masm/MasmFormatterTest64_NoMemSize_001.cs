...
namespace Iced.UnitTests.Intel.FormatterTests.Masm {
	public sealed class MasmFormatterTest64_NoMemSize_001 : FormatterTest {
		[Theory]
		...
		static readonly string[] formattedStrings = new string[InstructionInfos64_001.AllInfos_Length] {
			...
			"test rcx,0FFFFFFFF8412A55Ah",
			"test qword ptr [rax],0FFFFFFFF8412A55Ah",
			"not cx",
			"not word ptr [rax]",
			"not ecx",
			"not dword ptr [rax]",
