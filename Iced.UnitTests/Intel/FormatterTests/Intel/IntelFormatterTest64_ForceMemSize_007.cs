...
namespace Iced.UnitTests.Intel.FormatterTests.Intel {
	public sealed class IntelFormatterTest64_ForceMemSize_007 : FormatterTest {
		[Theory]
		...
		static readonly string[] formattedStrings = new string[InstructionInfos64_007.AllInfos_Length] {
			...
			"mov word ptr fs:[0xf0debc9a78563412], ax",
			"addr32 mov word ptr fs:[0x78563412], ax",
			"mov dword ptr fs:[0xf0debc9a78563412], eax",
			"addr32 mov dword ptr fs:[0x78563412], eax",
			"mov qword ptr fs:[0xf0debc9a78563412], rax",
			"addr32 mov qword ptr fs:[0x78563412], rax",
			...
			"vcmpss k2{k3}{sae}, xmm6, xmm3, -0x5b",
			"vcmpsd k2{k3}{sae}, xmm6, xmm3, -0x5b",
			...
			"vrndscaleps zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vrndscalepd zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vrndscaless xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"vrndscalesd xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"vgetmantps zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vgetmantpd zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vgetmantss xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"vgetmantsd xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"vrangess xmm2{k3}{z}{sae}, xmm6, xmm3, -0x5b",
			"vrangesd xmm2{k3}{sae}, xmm6, xmm3, -0x5b",
			"vfixupimmss xmm2{k3}{z}{sae}, xmm6, xmm3, -0x5b",
			"vfixupimmsd xmm2{k3}{sae}, xmm6, xmm3, -0x5b",
			"vreduceps zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vreducepd zmm2{k3}{z}{sae}, zmm3, -0x5b",
			"vreducess xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"vreducesd xmm18{k3}{sae}, xmm14, xmm3, -0x5b",
			"mov eax, es",
			"mov eax, cs",
			"mov eax, ss",
			"mov eax, ds",
			...
			"bndcn bnd3, rax",
			"mov cl, byte ptr [rax]",
			"mov cl, byte ptr [rax-0x12]",
			"mov cl, byte ptr [rax-0x12345678]",
			"mov cl, byte ptr [0x7fffffffedcba97e]",
			"mov cl, byte ptr [0xedcba97f]",
			"mov cl, byte ptr [rax+0x12]",
			"mov cl, byte ptr [rax+0x12345678]",
			"mov cl, byte ptr [0x800000001234566e]",
			"mov cl, byte ptr [0x1234566f]",
			"mov cl, byte ptr [rax+rcx]",
			"mov cl, byte ptr [rax+rcx*2]",
			"mov cl, byte ptr [rax+rcx*4]",
			"mov cl, byte ptr [rax+rcx*8]",
			"mov cl, byte ptr [rax+rcx-0x12]",
			"mov cl, byte ptr [rax+rcx*2-0x12]",
			"mov cl, byte ptr [rax+rcx*4-0x12]",
			"mov cl, byte ptr [rax+rcx*8-0x12]",
			"mov cl, byte ptr [rax+rcx+0x12]",
			"mov cl, byte ptr [rax+rcx*2+0x12]",
			"mov cl, byte ptr [rax+rcx*4+0x12]",
			"mov cl, byte ptr [rax+rcx*8+0x12]",
			"mov cl, byte ptr [rax+rcx-0x12345678]",
			"mov cl, byte ptr [rax+rcx*2-0x12345678]",
			"mov cl, byte ptr [rax+rcx*4-0x12345678]",
			"mov cl, byte ptr [rax+rcx*8-0x12345678]",
			"mov cl, byte ptr [rax+rcx+0x12345678]",
			"mov cl, byte ptr [rax+rcx*2+0x12345678]",
			"mov cl, byte ptr [rax+rcx*4+0x12345678]",
			"mov cl, byte ptr [rax+rcx*8+0x12345678]",
			"mov cl, byte ptr [rcx*1-0x12345678]",
			"mov cl, byte ptr [rbp+rcx*2-0x12]",
			"mov cl, byte ptr [rbp+rcx*4-0x12345678]",
			"mov cl, byte ptr [rcx*8-0x12345678]",
			"mov cl, byte ptr [rcx*1+0x12345678]",
			"mov cl, byte ptr [rbp+rcx*2+0x12]",
			"mov cl, byte ptr [rbp+rcx*4+0x12345678]",
			"mov cl, byte ptr [rcx*8+0x12345678]",
			"mov cl, byte ptr fs:[rax]",
			"mov cl, byte ptr fs:[rax-0x12]",
			"mov cl, byte ptr fs:[rax-0x12345678]",
			"mov cl, byte ptr fs:[0x7fffffffedcba97f]",
			"mov cl, byte ptr fs:[0xedcba980]",
			"mov cl, byte ptr fs:[rax+0x12]",
			"mov cl, byte ptr fs:[rax+0x12345678]",
			"mov cl, byte ptr fs:[0x800000001234566f]",
			"mov cl, byte ptr fs:[0x12345670]",
			"mov cl, byte ptr fs:[rax+rcx]",
			"mov cl, byte ptr fs:[rax+rcx*2]",
			"mov cl, byte ptr fs:[rax+rcx*4]",
			"mov cl, byte ptr fs:[rax+rcx*8]",
			"mov cl, byte ptr fs:[rax+rcx-0x12]",
			"mov cl, byte ptr fs:[rax+rcx*2-0x12]",
			"mov cl, byte ptr fs:[rax+rcx*4-0x12]",
			"mov cl, byte ptr fs:[rax+rcx*8-0x12]",
			"mov cl, byte ptr fs:[rax+rcx+0x12]",
			"mov cl, byte ptr fs:[rax+rcx*2+0x12]",
			"mov cl, byte ptr fs:[rax+rcx*4+0x12]",
			"mov cl, byte ptr fs:[rax+rcx*8+0x12]",
			"mov cl, byte ptr fs:[rax+rcx-0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*2-0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*4-0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*8-0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx+0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*2+0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*4+0x12345678]",
			"mov cl, byte ptr fs:[rax+rcx*8+0x12345678]",
			"mov cl, byte ptr fs:[rcx*1-0x12345678]",
			"mov cl, byte ptr fs:[rbp+rcx*2-0x12]",
			"mov cl, byte ptr fs:[rbp+rcx*4-0x12345678]",
			"mov cl, byte ptr fs:[rcx*8-0x12345678]",
			"mov cl, byte ptr fs:[rcx*1+0x12345678]",
			"mov cl, byte ptr fs:[rbp+rcx*2+0x12]",
			"mov cl, byte ptr fs:[rbp+rcx*4+0x12345678]",
			"mov cl, byte ptr fs:[rcx*8+0x12345678]",
			...
			"prefetch_exclusive-r3 byte ptr [rax]",
			"prefetch_exclusive-r4 byte ptr [rax]",
			"prefetch_exclusive-r5 byte ptr [rax]",
			"prefetch_exclusive-r6 byte ptr [rax]",
			"prefetch_exclusive-r7 byte ptr [rax]",
			"femms",
			...
			"vfmaddss xmm2, xmm6, dword ptr [rax], xmm4",
			"vfmaddss xmm2, xmm6, xmm4, xmm3",
			"vfmaddss xmm2, xmm6, xmm4, dword ptr [rax]",
			"vfmaddsd xmm2, xmm6, xmm3, xmm4",
			"vfmaddsd xmm2, xmm6, qword ptr [rax], xmm4",
			"vfmaddsd xmm2, xmm6, xmm4, xmm3",
			"vfmaddsd xmm2, xmm6, xmm4, qword ptr [rax]",
			...
			"vfmsubss xmm2, xmm6, dword ptr [rax], xmm4",
			"vfmsubss xmm2, xmm6, xmm4, xmm3",
			"vfmsubss xmm2, xmm6, xmm4, dword ptr [rax]",
			"vfmsubsd xmm2, xmm6, xmm3, xmm4",
			"vfmsubsd xmm2, xmm6, qword ptr [rax], xmm4",
			"vfmsubsd xmm2, xmm6, xmm4, xmm3",
			"vfmsubsd xmm2, xmm6, xmm4, qword ptr [rax]",
			...
			"vfnmaddss xmm2, xmm6, dword ptr [rax], xmm4",
			"vfnmaddss xmm2, xmm6, xmm4, xmm3",
			"vfnmaddss xmm2, xmm6, xmm4, dword ptr [rax]",
			"vfnmaddsd xmm2, xmm6, xmm3, xmm4",
			"vfnmaddsd xmm2, xmm6, qword ptr [rax], xmm4",
			"vfnmaddsd xmm2, xmm6, xmm4, xmm3",
			"vfnmaddsd xmm2, xmm6, xmm4, qword ptr [rax]",
			...
			"vfnmsubss xmm2, xmm6, dword ptr [rax], xmm4",
			"vfnmsubss xmm2, xmm6, xmm4, xmm3",
			"vfnmsubss xmm2, xmm6, xmm4, dword ptr [rax]",
			"vfnmsubsd xmm2, xmm6, xmm3, xmm4",
			"vfnmsubsd xmm2, xmm6, qword ptr [rax], xmm4",
			"vfnmsubsd xmm2, xmm6, xmm4, xmm3",
			"vfnmsubsd xmm2, xmm6, xmm4, qword ptr [rax]",
			...
			"vprotb xmm2, xmmword ptr [rax], -0x5b",
			"vprotw xmm2, xmm3, -0x5b",
			"vprotw xmm2, xmmword ptr [rax], -0x5b",
			"vprotd xmm2, xmm3, -0x5b",
			"vprotd xmm2, xmmword ptr [rax], -0x5b",
			"vprotq xmm2, xmm3, -0x5b",
			"vprotq xmm2, xmmword ptr [rax], -0x5b",
			"vpcomb xmm2, xmm6, xmm3, -0x5b",
			"vpcomb xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomw xmm2, xmm6, xmm3, -0x5b",
			"vpcomw xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomd xmm2, xmm6, xmm3, -0x5b",
			"vpcomd xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomq xmm2, xmm6, xmm3, -0x5b",
			"vpcomq xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomub xmm2, xmm6, xmm3, -0x5b",
			"vpcomub xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomuw xmm2, xmm6, xmm3, -0x5b",
			"vpcomuw xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomud xmm2, xmm6, xmm3, -0x5b",
			"vpcomud xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"vpcomuq xmm2, xmm6, xmm3, -0x5b",
			"vpcomuq xmm2, xmm6, xmmword ptr [rax], -0x5b",
			"blcfill esi, ebx",
			...
			"vfrczss xmm1, xmm5",
			"vfrczss xmm2, dword ptr [rax]",
			"vfrczsd xmm1, xmm5",
			"vfrczsd xmm2, qword ptr [rax]",
			...
			"bextr edx, dword ptr [rax], 0x34125aa5",
			"bextr rdx, rbx, -0x5aa5edcc",
			"bextr rdx, qword ptr [rax], -0x5aa5edcc",
			"lwpins esi, ebx, -0x5aa5edcc",
			"lwpins esi, dword ptr [rax], -0x5aa5edcc",
			"lwpins rsi, ebx, -0x5aa5edcc",
			"lwpins rsi, dword ptr [rax], -0x5aa5edcc",
			"lwpval esi, ebx, -0x5aa5edcc",
			"lwpval esi, dword ptr [rax], -0x5aa5edcc",
			"lwpval rsi, ebx, -0x5aa5edcc",
			"lwpval rsi, dword ptr [rax], -0x5aa5edcc",
			"pi2fw mmx1, mmx5",
			"pi2fw mmx1, qword ptr [rax-0x5aa5edcc]",
			"pi2fd mmx1, mmx5",
			"pi2fd mmx1, qword ptr [rax-0x5aa5edcc]",
			"pf2iw mmx1, mmx5",
			"pf2iw mmx1, qword ptr [rax-0x5aa5edcc]",
			"pf2id mmx1, mmx5",
			"pf2id mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrcpv mmx1, mmx5",
			"pfrcpv mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrsqrtv mmx1, mmx5",
			"pfrsqrtv mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfnacc mmx1, mmx5",
			"pfnacc mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfpnacc mmx1, mmx5",
			"pfpnacc mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfcmpge mmx1, mmx5",
			"pfcmpge mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfmin mmx1, mmx5",
			"pfmin mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrcp mmx1, mmx5",
			"pfrcp mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrsqrt mmx1, mmx5",
			"pfrsqrt mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfsub mmx1, mmx5",
			"pfsub mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfadd mmx1, mmx5",
			"pfadd mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfcmpgt mmx1, mmx5",
			"pfcmpgt mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfmax mmx1, mmx5",
			"pfmax mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrcpit1 mmx1, mmx5",
			"pfrcpit1 mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrsqit1 mmx1, mmx5",
			"pfrsqit1 mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfsubr mmx1, mmx5",
			"pfsubr mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfacc mmx1, mmx5",
			"pfacc mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfcmpeq mmx1, mmx5",
			"pfcmpeq mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfmul mmx1, mmx5",
			"pfmul mmx1, qword ptr [rax-0x5aa5edcc]",
			"pfrcpit2 mmx1, mmx5",
			"pfrcpit2 mmx1, qword ptr [rax-0x5aa5edcc]",
			"pmulhrw mmx1, mmx5",
			"pmulhrw mmx1, qword ptr [rax-0x5aa5edcc]",
			"pswapd mmx1, mmx5",
			"pswapd mmx1, qword ptr [rax-0x5aa5edcc]",
			"pavgusb mmx1, mmx5",
			"pavgusb mmx1, qword ptr [rax-0x5aa5edcc]",
			"sal bh, 0x5a",
			...
			"fstp st(3), st",
			"test dh, -0x5b",
			"test byte ptr [rax], -0x5b",
			"test si, 0x5aa5",
			"test word ptr [rax], 0x5aa5",
			"test esi, -0x5476a55b",
			"test dword ptr [rax], -0x5476a55b",
			"test rsi, -0x5476a55b",
			"test qword ptr [rax], -0x5476a55b",
