...
namespace Iced.UnitTests.Intel.DecoderTests {
	public sealed class MemoryTest32_002 : DecoderTest {
		...
		void Test32_DecodeMemOps_as32_vsib(string hexBytes, Code code, Register register, Register prefixSeg, Register segReg, Register baseReg, Register indexReg, int scale, uint displ, int displSize) =>
