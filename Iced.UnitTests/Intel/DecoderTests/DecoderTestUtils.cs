...
namespace Iced.UnitTests.Intel.DecoderTests {
	...
	public static class DecoderTestUtils {
		...
		static IEnumerable<Code> GetCode64() {
			...
			yield return Code.Sldt_RqMw;
			yield return Code.Str_RqMw;
			yield return Code.Lldt_RqMw;
			yield return Code.Ltr_RqMw;
			yield return Code.Verr_RqMw;
			yield return Code.Verw_RqMw;
			yield return Code.Sgdtq_Ms;
			yield return Code.Sidtq_Ms;
			yield return Code.Lgdtq_Ms;
			yield return Code.Lidtq_Ms;
			yield return Code.Smsw_RqMw;
			yield return Code.Lmsw_RqMw;
