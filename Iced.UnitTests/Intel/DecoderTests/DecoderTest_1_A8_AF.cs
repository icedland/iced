...
namespace Iced.UnitTests.Intel.DecoderTests {
	public sealed class DecoderTest_1_A8_AF : DecoderTest {
		[Fact]
		void Test16_Test_AL_imm8_1() {
			var decoder = CreateDecoder16("A8 5A");
			var instr = decoder.Decode();

			Assert.Equal(Code.Test_AL_imm8, instr.Code);
		...
		void Test64_Test_AL_imm8_1(string hexBytes, int byteLength) {
		...
		[Fact]
		void Test16_Test_AX_imm16_1() {
			var decoder = CreateDecoder16("A9 5AA5");
			var instr = decoder.Decode();

			Assert.Equal(Code.Test_AX_imm16, instr.Code);
			Assert.Equal(2, instr.OpCount);
		...
		void Test64_Test_AX_imm16_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Test_EAX_imm32_1() {
			var decoder = CreateDecoder16("66 A9 5AA51234");
			var instr = decoder.Decode();

			Assert.Equal(Code.Test_EAX_imm32, instr.Code);
			Assert.Equal(2, instr.OpCount);
		...
		void Test64_Test_EAX_imm32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Test_RAX_imm32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Test_RAX_imm32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("AA", 1)]
		void Test16_Stosb_m8_AL_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Stosb_m8_AL, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("67 AA", 2)]
		void Test16_Stosb_m8_AL_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("67 AA", 2)]
		void Test32_Stosb_m8_AL_1(string hexBytes, int byteLength) {
		...
		[Theory]
		[InlineData("AA", 1)]
		void Test32_Stosb_m8_AL_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosb_m8_AL_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosb_m8_AL_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AB", 1)]
		void Test16_Stosw_m16_AX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Stosw_m16_AX, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("67 AB", 2)]
		void Test16_Stosw_m16_AX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		void Test32_Stosw_m16_AX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("66 AB", 2)]
		void Test32_Stosw_m16_AX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosw_m16_AX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosw_m16_AX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("66 AB", 2)]
		void Test16_Stosd_m32_EAX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Stosd_m32_EAX, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("66 67 AB", 3)]
		void Test16_Stosd_m32_EAX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("67 AB", 2)]
		void Test32_Stosd_m32_EAX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AB", 1)]
		void Test32_Stosd_m32_EAX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosd_m32_EAX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("AB", 1)]
		[InlineData("47 AB", 2)]
		void Test64_Stosd_m32_EAX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Stosq_m64_RAX_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Stosq_m64_RAX, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[InlineData("48 AB", 2)]
		[InlineData("4F AB", 2)]
		void Test64_Stosq_m64_RAX_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test16_Lodsb_AL_m8_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Lodsb_AL_m8, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test16_Lodsb_AL_m8_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("64 67 AC", 3, Register.FS, Register.FS)]
		[InlineData("65 67 AC", 3, Register.GS, Register.GS)]
		void Test32_Lodsb_AL_m8_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("64 AC", 2, Register.FS, Register.FS)]
		[InlineData("65 AC", 2, Register.GS, Register.GS)]
		void Test32_Lodsb_AL_m8_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsb_AL_m8_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsb_AL_m8_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test16_Lodsw_AX_m16_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Lodsw_AX_m16, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test16_Lodsw_AX_m16_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		void Test32_Lodsw_AX_m16_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test32_Lodsw_AX_m16_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsw_AX_m16_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsw_AX_m16_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("64 66 AD", 3, Register.FS, Register.FS)]
		[InlineData("65 66 AD", 3, Register.GS, Register.GS)]
		void Test16_Lodsd_EAX_m32_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Lodsd_EAX_m32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[InlineData("64 66 67 AD", 4, Register.FS, Register.FS)]
		[InlineData("65 66 67 AD", 4, Register.GS, Register.GS)]
		void Test16_Lodsd_EAX_m32_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("64 67 AD", 3, Register.FS, Register.FS)]
		[InlineData("65 67 AD", 3, Register.GS, Register.GS)]
		void Test32_Lodsd_EAX_m32_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("64 AD", 2, Register.FS, Register.FS)]
		[InlineData("65 AD", 2, Register.GS, Register.GS)]
		void Test32_Lodsd_EAX_m32_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsd_EAX_m32_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsd_EAX_m32_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Lodsq_RAX_m64_1(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Lodsq_RAX_m64, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Lodsq_RAX_m64_2(string hexBytes, int byteLength, Register seg, Register segPrefix) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AE", 1)]
		void Test16_Scasb_AL_m8_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Scasb_AL_m8, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("67 AE", 2)]
		void Test16_Scasb_AL_m8_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("67 AE", 2)]
		void Test32_Scasb_AL_m8_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AE", 1)]
		void Test32_Scasb_AL_m8_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasb_AL_m8_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasb_AL_m8_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AF", 1)]
		void Test16_Scasw_AX_m16_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Scasw_AX_m16, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("67 AF", 2)]
		void Test16_Scasw_AX_m16_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		void Test32_Scasw_AX_m16_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("66 AF", 2)]
		void Test32_Scasw_AX_m16_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasw_AX_m16_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasw_AX_m16_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("66 AF", 2)]
		void Test16_Scasd_EAX_m32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Scasd_EAX_m32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Theory]
		[InlineData("66 67 AF", 3)]
		void Test16_Scasd_EAX_m32_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder16(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("67 AF", 2)]
		void Test32_Scasd_EAX_m32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		[Theory]
		[InlineData("AF", 1)]
		void Test32_Scasd_EAX_m32_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder32(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasd_EAX_m32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[InlineData("AF", 1)]
		[InlineData("47 AF", 2)]
		void Test64_Scasd_EAX_m32_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Scasq_RAX_m64_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Scasq_RAX_m64, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[InlineData("48 AF", 2)]
		[InlineData("4F AF", 2)]
		void Test64_Scasq_RAX_m64_2(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
