...
namespace Iced.UnitTests.Intel.DecoderTests {
	public sealed class DecoderTest_1_38_3F : DecoderTest {
		[Fact]
		void Test16_Cmp_rm8_r8_1() {
			var decoder = CreateDecoder16("38 CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_rm8_r8, instr.Code);
		...
		void Test64_Cmp_rm8_r8_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
		...
		[Fact]
		void Test16_Cmp_rm16_r16_1() {
			var decoder = CreateDecoder16("39 CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_rm16_r16, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(2, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_rm16_r16_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Cmp_rm32_r32_1() {
			var decoder = CreateDecoder16("66 39 CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_rm32_r32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(3, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_rm32_r32_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Cmp_rm64_r64_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_rm64_r64, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Fact]
		void Test16_Cmp_r8_rm8_1() {
			var decoder = CreateDecoder16("3A CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_r8_rm8, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(2, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_r8_rm8_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Cmp_r16_rm16_1() {
			var decoder = CreateDecoder16("3B CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_r16_rm16, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(2, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_r16_rm16_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Cmp_r32_rm32_1() {
			var decoder = CreateDecoder16("66 3B CE");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_r32_rm32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(3, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_r32_rm32_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Cmp_r64_rm64_1(string hexBytes, int byteLength, Register reg1, Register reg2) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_r64_rm64, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		[Fact]
		void Test16_Cmp_AL_imm8_1() {
			var decoder = CreateDecoder16("3C 5A");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_AL_imm8, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(2, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_AL_imm8_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Cmp_AX_imm16_1() {
			var decoder = CreateDecoder16("3D 5AA5");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_AX_imm16, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(3, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
		...
		void Test64_Cmp_AX_imm16_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		[Fact]
		void Test16_Cmp_EAX_imm32_1() {
			var decoder = CreateDecoder16("66 3D 5AA51234");
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_EAX_imm32, instr.Code);
			Assert.Equal(2, instr.OpCount);
		...
		void Test64_Cmp_EAX_imm32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();
		...
		void Test64_Cmp_RAX_imm32_1(string hexBytes, int byteLength) {
			var decoder = CreateDecoder64(hexBytes);
			var instr = decoder.Decode();

			Assert.Equal(Code.Cmp_RAX_imm32, instr.Code);
			Assert.Equal(2, instr.OpCount);
			Assert.Equal(byteLength, instr.ByteLength);
			Assert.False(instr.HasPrefixRepe);
			Assert.False(instr.HasPrefixRepne);
